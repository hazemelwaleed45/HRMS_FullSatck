...
class AttendanceController extends Controller
{
    ...
    public function getMonthlyReport(Request $request )
    {
        ...
        ->select(
            ...
            'employees.base_salary as basic_salary',
            ...
            DB::raw('(employees.base_salary / 22) * COUNT(DISTINCT attendances.id) + SUM(CASE WHEN salary_actions.type = "bonus" THEN salary_actions.amount ELSE 0 END) - SUM(CASE WHEN salary_actions.type = "deduction" THEN salary_actions.amount ELSE 0 END) as net_salary')
        )
